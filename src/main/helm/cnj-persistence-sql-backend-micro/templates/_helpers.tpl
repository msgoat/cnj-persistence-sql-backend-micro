...
*/}}
{{- define "cnj-persistence-sql-backend-micro.name" -}}
...
*/}}
{{- define "cnj-persistence-sql-backend-micro.fullname" -}}
...
*/}}
{{- define "cnj-persistence-sql-backend-micro.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "cnj-persistence-sql-backend-micro.fullname" .) .Values.serviceAccount.name }}
{{- else }}
